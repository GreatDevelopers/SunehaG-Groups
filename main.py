...
#list-comphrehension
[(create_group(str(course_shortform[course_code[1]])), create_group(str(course_shortform[course_code[1]])+"_"+str(branch_shortform[branch_code[1]])), create_group(str(course_shortform[course_code[1]])+"_"+str(branch_shortform[branch_code[1]])+"_"+str(student_data[5])), create_group(str(course_shortform[course_code[1]])+"_"+str(branch_shortform[branch_code[1]])+"_"+str(student_data[5])+"_"+str(student_data[9])), create_group(str(course_shortform[course_code[1]])+"_"+str(branch_shortform[branch_code[1]])+"_"+str(student_data[5])+"_"+str(student_data[9])+"_"+      str(student_data[10]))) for student_data in var3.execute() for branch_code in var2.execute() if str(student_data[1]) in str(branch_code[2]) and str(student_data[2]) in str(branch_code[0]) for course_code in var1.execute() if str(student_data[1]) in course_code[0]]
